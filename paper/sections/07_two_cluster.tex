...
候选输入特征集包括前述综合排序得到的 Top20、Top50 和 all acoustic 特征。原第 5 阶段方案为 \feature{top20_biomarkers} / \feature{pca_5} / KMeans。经第 5b 阶段无奖励权重敏感性分析后，该方案仍为第一名频率最高的候选，但 top-1 频率仅为 37.3\%，低于 60\% 的稳健主推荐阈值。因此，本文将其表述为“相对推荐候选方案”，不再作为唯一最优结论。
