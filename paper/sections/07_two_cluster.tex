...
候选输入特征集包括前述综合排序得到的 Top20、Top50 和 all acoustic 特征。主方案选择 \feature{top20_biomarkers} / \feature{pca_5} / KMeans。所有候选方案先执行标准化，再按方案进行 PCA 和聚类。聚类输入不包含 \feature{id}、\feature{gender}、\feature{class}、\feature{sex_male}、\feature{record_count} 或任何标签列。
